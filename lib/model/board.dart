...
import '/controller/scheduledata.dart';
...
class BrowseDetails extends StatefulWidget {
  ...
  BrowseDetails({Key? key, required this.idTutor, required this.subject});
  @override
...
List<String> _scheduleDay = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];  String harini = 'Today';
